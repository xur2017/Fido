# Generated by Django 3.0.2 on 2020-01-25 03:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('breed', models.CharField(choices=[('B', 'Beagle'), ('FB', 'French Bulldog'), ('GR', 'Golden Retriever'), ('GS', 'German Shepard'), ('L', 'Laborador')], default='B', max_length=2)),
                ('disposition', models.CharField(choices=[('C', 'Good with Children'), ('OA', 'Good with Other Animals'), ('L', 'Animal must be leashed at all times'), ('NA', 'Not Applicable')], default='NA', max_length=2)),
